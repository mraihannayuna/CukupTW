...
class TerbaruFragment : Fragment() {
    ...
    lateinit var binding: FragmentTerbaruRepublikaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTerbaruRepublikaBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TerbaruViewModel.getRepublikaTerbaruNews()

        TerbaruViewModel.republikaTerbaruNews.observe(viewLifecycleOwner) { dataNews ->
